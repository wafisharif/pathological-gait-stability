...
def measure(policy, base_strength, pf_strength_factor, pf_vmax_factor, max_steps=1000, contact_threshold=10.0):
    ...
    scaled[pf_indices, 6] = original_gainprm[pf_indices, 6] * pf_vmax_factor
...
if __name__ == "__main__":
    ...
    print("Combining plantarflexor strength + vmax reduction, base strength=0.6\n")
    configs = [
        (0.6, 1.0), (0.6, 0.8), (0.6, 0.6), (0.6, 0.4),
        (0.7, 1.0), (0.7, 0.8), (0.7, 0.6), (0.7, 0.4),
        (0.8, 1.0), (0.8, 0.8), (0.8, 0.6), (0.8, 0.4),
    ]
    print("pf_strength, pf_vmax, steps, conf, ds_pct, n_strikes")
    for pf_s, pf_v in configs:
        steps, conf, ds, n = measure(policy, base_strength=0.6, pf_strength_factor=pf_s, pf_vmax_factor=pf_v)
        print(f"{pf_s}, {pf_v}, {steps}, {conf}, {ds:.2f}, {n}")